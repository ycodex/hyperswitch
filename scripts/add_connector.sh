...
function find_prev_connector() {
    ...
    connectors=(aci adyen airwallex applepay authorizedotnet bambora bitpay bluesnap braintree checkout coinbase cybersource dlocal dummyconnector fiserv forte globalpay iatapay klarna mollie multisafepay nexinets nuvei opayo opennode payeezy paypal payu rapyd shift4 stripe trustpay worldline worldpay "$1")
